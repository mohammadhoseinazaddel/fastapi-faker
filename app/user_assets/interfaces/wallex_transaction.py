...
from ..models.wallex_transaction import UasWallexTransaction, wallex_transaction_crud
from ..models.schemas.wallex_transaction import CreateWallexTransaction, UpdateWallexTransaction, GetMultiWallexTransaction


class WallexTransactionInterface(InterfaceBase):
    ...
    def __init__(self, crud: CRUDBase, create_schema, update_schema, get_multi_schema):
        ...
        self.crud = wallex_transaction_crud
...
wallex_transaction_agent = WallexTransactionInterface(
    crud=wallex_transaction_crud,
    create_schema=CreateWallexTransaction,
    update_schema=UpdateWallexTransaction,
    get_multi_schema=GetMultiWallexTransaction
)
